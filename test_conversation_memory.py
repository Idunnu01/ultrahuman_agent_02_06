#!/usr/bin/env python3
"""
Test conversation memory and follow-up capabilities
"""
...
def test_conversation_memory():
    ...
    with app.app_context():
        ...
        try:
            ...
            conversations = Conversation.query.filter_by(user_id=test_user_id).all()
        ...
        try:
            ...
            conversations = Conversation.query.filter_by(user_id=test_user_id).order_by(Conversation.created_at).all()
        ...
        try:
            # Final statistics
            total_conversations = Conversation.query.filter_by(user_id=test_user_id).count()
            follow_up_conversations = Conversation.query.filter_by(
                user_id=test_user_id, is_follow_up=True
            ).count()
            ...
            all_convs = Conversation.query.filter_by(user_id=test_user_id).all()
            ...
            Conversation.query.filter_by(user_id=test_user_id).delete()
